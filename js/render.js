...
export function renderTitle() {
    ...
    if (pageIndex > (Math.ceil(parseInt(queryObj.numFound / 100)))) {
        document.getElementById("fwd").style.opacity = "30%";
        document.getElementById("fwd").style.pointerEvents = "none";
    } else {
        document.getElementById("fwd").style.opacity = "100%";
        document.getElementById("fwd").style.pointerEvents = "auto";
    }
}
